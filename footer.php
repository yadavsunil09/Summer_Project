        ...
        <div class="row">
            <div class="col-md-3">
                <?php
                    ...
                    $footer = $db->getResult();  ?>
                <h3>Online Bookstore Store</h3>
                <p>Buy Old Second Hand Books and New Books at One Place.</p>
            </div>
            <div class="col-md-3">
                <h3>Categories</h3>
                <ul class="menu-list">
            ...
            <div class="col-md-3">
                ...
                <ul class="menu-list">
                    <?php if(!empty($footer[0]['contact_address'])){ ?>
                        <li><i class="fa fa-home" ></i>Bhaisipati, Lalitpur</span></li>
                    <?php } ?>
                    <?php if(!empty($footer[0]['contact_phone'])){ ?>
                        <li><i class="fa fa-phone" ></i><span>: 9812121212</span></li>
                    <?php } ?>
                    <?php if(!empty($footer[0]['contact_email'])){ ?>
                        <li><i class="fa fa-envelope" ></i><span>:info@OnlineBookStore.comb</span></li>
                    <?php } ?>
                </ul>
            </div>
            <div class="col-md-12"><br>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Created by <a href="https://www.facebook.com/chunil.ray.9" target="_blank">Sunil</a></span>
            </div>
        </div>
    </div>
</div>
